    ...
    return (
        <div className=' h-screen flex flex-col items-center justify-center mx-10 gap-2 lg:w-1/2 static'>
            <div className=' flex flex-col items-center justify-center'>
                <img className='w-[25vw] h-[25vh] md:w-[15vw] md:h-[30vh] bg-pink-600 rounded-full flex justify-center items-center' src={main} alt="" />
                <h1 className=' uppercase font-bold text-3xl md:text-5xl text-blue-800'>hitesh kalra</h1>
